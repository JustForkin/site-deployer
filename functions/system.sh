...
function checkCompatibility() {
    ...
    echo "WP_DEFAULT_PLUGINS=regenerate-thumbnails hide-admin-bar all-404-redirect-to-homepage loco-translate wp-mail-smtp invisible-recaptcha wp-redis wp-maintenance-mode akismet backwpup disable-gutenberg" >> $SD_CONF_FILE
    echo "" >> ${SD_CONF_FILE}
    echo ""
