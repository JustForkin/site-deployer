function newDeploy() {
    source $(readlink -f $(dirname $0))/functions/nginx.sh
    source $(readlink -f $(dirname $0))/functions/resume.sh
    source $(readlink -f $(dirname $0))/functions/vars.sh
    source $(readlink -f $(dirname $0))/functions/cloudflare.sh
...
function install() {
    source $(readlink -f $(dirname $0))/functions/vars.sh
    source $(readlink -f $(dirname $0))/functions/letsencrypt.sh
    source $(readlink -f $(dirname $0))/functions/cloudflare.sh
    source $(readlink -f $(dirname $0))/functions/proftpd.sh
    source $(readlink -f $(dirname $0))/functions/wordpress.sh
    source $(readlink -f $(dirname $0))/functions/database.sh
